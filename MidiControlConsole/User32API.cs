...
namespace MidiControl
{
    public class User32API
    {
        ...
        public static void Scroll(int amount)
        {
            ...
            SendInput(1, new INPUT[] { x }, Marshal.SizeOf(x));
        }

        public static void Type(List<ScanCodeShort> keys)
        {
            keys = new List<User32API.ScanCodeShort>() { User32API.ScanCodeShort.KEY_L };
            ...
            Console.WriteLine(SendInput(Convert.ToUInt32(key_actions.Count), key_actions.ToArray(), Marshal.SizeOf(typeof(INPUT))));
